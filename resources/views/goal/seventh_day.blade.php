...
<body>
    ...
    <div class=main>
        ...
        <tr>
            ...
            <input type="hidden" name="sixth_day" value="{{$item->fifth_day}}">
            <input type="hidden" name="seventh_day" value="{{$item->sixth_day}}">
           
            <td><input type="hidden" name="first_day" value="{{$item->id}}">{{$item->seventh_day}}</td>
